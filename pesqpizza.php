...
?>
  ...
  <center>
        <h2>PAINEL DE CONTROLE DO SISPIZZA</h2>
                    ...
                    <a href = "cadastroclientes.php"><img src="img/op_funcionario.png" alt="op-clientes" width="100" height="100"></a>
                    ...
                    <a href = "carrinhopedidos.php"><img src="img/carrinho.png" alt="op-pizza" width="100" height="100"></a>
    ...
    <table width="800" border="0" bgcolor="#fff" >
     ...
     <table width="800" border="0" cellpadding="0" cellspacing="0">
        ...
        <form id="pesquisa" name="pesquisa" method="post" action=""  onsubmit="return validaCampo(); return false;">
            <table width="800" border="0">   
                <tr>
                    <center><h2>PESQUISA DE PIZZAS</h2></center>
                     <td align="center">Sabor Pizza:</td>
                     </tr><tr>
                     <td align="center"><input name="sabor" type="text" id="sabor" size="40" maxlength="60" /></td>
                     </tr><tr>
