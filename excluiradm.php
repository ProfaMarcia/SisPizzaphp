...
?>
  ...
  <center>
     ...
     <center> 
      ...
      <table width="668" border="0" cellpadding="0" cellspacing="0">
	   ...
	   <tr>
        ...
        <center><H2>EXCLUSÃO DE ADMINISTRADORES</h2>
            <br>Cuidado! Se clicar no botão "EXCLUIR", você apagará todos os dados do cadastro do Adm.
    ...
    echo '<td align="center"><h3>ID ADM:</h3></td>
        </tr>
        <tr>
      <td align="center"><input readonly="readonly" name="id" value="'.$_GET['ID'].'" type="text" id="id" size="1" />
            <tr>
             <br> 
      <td align="center"><p>
 ...
 if(isset($_GET['ID'])){
           $id = $_GET['ID']; // o codigo do cliente
        }
 ...
 $deleta = "DELETE from administradores WHERE id='$id'";
    mysql_query($deleta) or die(mysql_error());
     
    echo "<SCRIPT LANGUAGE='JavaScript' TYPE='text/javascript'>
        alert('Cadastro do Adm. excluído com sucesso!');
