...
?>
  ...
  <center>
     ...
     <center> 
      ...
      <table width="668" border="0" cellpadding="0" cellspacing="0">
	   ...
	   <tr>
        ...
        <center><H2>EXCLUSÃO DE CLIENTES</h2>
            <br>Cuidado! Se clicar no botão "EXCLUIR", você apagará todos os dados do cadastro do Cliente.
    ...
    echo '<td align="center"><h3>ID Cliente:</h3></td>
        </tr>
        <tr>
 ...
 $deleta = "DELETE from clientes WHERE id='$id'";
    mysql_query($deleta) or die(mysql_error());
     
    echo "<SCRIPT LANGUAGE='JavaScript' TYPE='text/javascript'>
        alert('Cadastro do cliente excluído com sucesso!');
