  ...
  <center>
    ...
    <table width="800" border="0" bgcolor="#fff" >
        ...
        <center> <table width="800" border="0" cellpadding="0" cellspacing="0">
          <tr>
        <center><h2>DÚVIDAS DOS CLIENTES</h2></center></tr>
<?php
...
include 'conexao-banco.php';
  ...
  echo '<form name="mensagens" method="post" action="'.$_SERVER["PHP_SELF"].'">';
   ...
   echo "<center><table><tr><td align='center' colspan='2'><a href='elogios.php'><img src='img/elogios.png' width='100' height='100'></a></td> ";
    ...
    echo "<center><td align='center' colspan='2'><a href='duvidas.php'><img src='img/dúvidas1.png' width='100' height='100'></a></td></tr> "; 
...
$contato_cliente = mysql_query("SELECT * FROM clientes")or die(mysql_error());
  ...
  $mensagens = mysql_query("SELECT * FROM contato where id_cliente='$cc[id]' and assunto='Duvidas'"); 
